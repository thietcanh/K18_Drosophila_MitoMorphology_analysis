#copy from untitled5*
#adding p.value and testing methods
    ...
    graph <- graph+labs(title=title.graph,y=y.lab.graph,x=line)+
      ...
      theme(legend.background = element_rect(fill = "transparent"),
            ...
            plot.background = element_rect(fill = "transparent",
                                           color = NA))
    print(graph)
    ggsave(paste(i,line,"formatted Pvalue.png"),path = "D:/Results/Graph/Mito by days/resize3x4 except larvae",bg = "white",width=3,height=4)
  }
}
